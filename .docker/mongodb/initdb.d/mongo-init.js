...
var dbUser = process.env.DB_USER || 'regularuser'
var dbPwd = process.env.DB_PWD || 'regularpassword'
var dbName = process.env.DB_NAME || 'production'
...
db.createUser({
	...
	'roles': [
		{
			'role': 'dbOwner',
			'db': process.env.DB_NAME || 'production',
		},
	],
})
